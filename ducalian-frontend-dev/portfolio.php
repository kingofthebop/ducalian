...
<section id="portfolio" class="content-top">
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 block">				
				<div class="block-pic">
					<img src="images/hawkes-drive.jpg" class="img-responsive" />
				</div>
				<div class="block-wrapper">	
					<h3>2 Hawkes Drive, Heatchote Lane, Leamington Spa</h3>					
					<p>Rapidiously create impactful e-commerce via market-driven synergy. Distinctively enhance professional process improvements with mission-critical action items. Appropriately.</p>					
				</div>				
			</div>
